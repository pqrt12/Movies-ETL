...
def wiki_movies_df_get(wiki_movies_file):
    ...
    try:
        ...
        e = sys.exc_info()[0]
        print(f"{WIKI_FILE_STR} {wiki_movies_file} json load failed: {e}")
        raise e
        return
...
def kaggle_metadata_get(kaggle_movies_file):
    try:
        ...
        e = sys.exc_info()[0]
        print(f"{KAGGLE_FILE_STR} {kaggle_movies_file} csv load failed: {e}")
        raise e
        return
...
def ratings_get(ratings_file):
    try:
        ...
        e = sys.exc_info()[0]
        print(f"{RATINGS_FILE_STR} {ratings_file} csv load failed: {e}")
        raise e
        return
...
def merge_datasets(wiki_movies_df, kaggle_metadata):
    try:
        ...
        e = sys.exc_info()[0]
        print(f"merge wiki_movies_df and kaggle_metadata failed: {e}.")
        raise e
        return
...
def merge_ratings(movies_df, ratings):
    try:
        ...
        e = sys.exc_info()[0]
        print(f"merge movies_df and ratings failed: {e}.")
        raise e
        return
...
def movies_etl(wiki_movies_file, kaggle_movies_file, ratings_file):
    try:
        ...
        e = sys.exc_info()[0]
        print(f"data ETL failed: {e}. skip postgres operations.")
        return -1
    ...
    try:
        ...
        e = sys.exc_info()[0]
        print(f"postgres movie_data create failed: {e}.")
        return -1
    ...
    try:
        ...
        e = sys.exc_info()[0]
        print(f'postgres table \"movies\" populated failed: {e}.')
        return -1
    ...
    try:
        ...
        e = sys.exc_info()[0]
        print(f'postgres table \"ratings\" populated failed: {e}.')
        return -1
    return 0
...
if __name__ == "__main__":
    ...
    if (ret == 0):
        print("\nThis data ETL is successful.")
    else:
        print("\nThis data ETL is failed.")
